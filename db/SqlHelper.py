...
'''
sql操作的基类
包括ip，端口，types类型(0 高匿，1 匿名，2 透明 3 无效代理)，protocol(0 http,1 https http),country(国家),area(省市),updatetime(更新时间)
 speed(连接速度)
'''
...
class SqlHelper(ISqlHelper):
    ...
    def select(self, count=None, conditions=None):
        ...
        query = self.session.query(Proxy.ip, Proxy.port, Proxy.protocol,
                                   Proxy.score, Proxy.country, Proxy.area,
                                   Proxy.updatetime, Proxy.speed)
