...
class Validator:
    ...
    def run(self):
        ...
        logging.info("Validator website is {}".format(VALIDATOR_BASE_URL))
        ...
        logging.info("Validator resting...")
